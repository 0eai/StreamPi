...
// Shown right after a share link is created (useLibraryActions.handleShare). Still no duration
// picker here on purpose: creating a link stays one click, and expiry is set afterwards from
// Settings → My Shares (ShareExpiryModal) for the minority of links that want a deadline. So this
// is purely "here's the link, copy it," same shape as CredentialsModal.jsx's copy pattern.
    ...
    return (
        <Modal isOpen={!!shareLink} onClose={onClose} title={<><Share2 className="w-5 h-5 text-purple-500" /> Share Link</>}>
            ...
            <p className="text-[11px] text-gray-500 mt-3">
                This link works until you revoke it. Set it to expire, or revoke it, from Settings &rarr; My Shares.
            </p>
